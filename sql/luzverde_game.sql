...
CREATE TABLE IF NOT EXISTS luzverde_sessions (
  ...
  sensitivity_level TINYINT NOT NULL DEFAULT 15,
  base_sensitivity TINYINT NOT NULL DEFAULT 15,
  difficulty_step TINYINT NOT NULL DEFAULT 2,
  difficulty_cap TINYINT NOT NULL DEFAULT 40,
  still_window_ms INT NOT NULL DEFAULT 6000,
  still_grace_ms INT NOT NULL DEFAULT 2000,
  still_min DOUBLE NOT NULL DEFAULT 0.015,
...
CREATE TABLE IF NOT EXISTS luzverde_participants (
  ...
  still_since_at TIMESTAMP NULL DEFAULT NULL,
  device_multiplier DOUBLE NOT NULL DEFAULT 1,
  calibration_samples INT NOT NULL DEFAULT 0,
  calibration_sum DOUBLE NOT NULL DEFAULT 0,
  calibration_sum_sq DOUBLE NOT NULL DEFAULT 0,
  calibration_stddev DOUBLE NULL DEFAULT NULL,
  calibration_valid TINYINT NOT NULL DEFAULT 1,
