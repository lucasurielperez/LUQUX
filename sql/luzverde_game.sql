...
CREATE TABLE IF NOT EXISTS luzverde_participants (
  ...
  KEY idx_luzverde_participants_armed_alive (session_id, armed, eliminated_at),
  KEY idx_luzverde_participants_last_seen (session_id, last_seen_at),
